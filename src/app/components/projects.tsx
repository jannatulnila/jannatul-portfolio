            ...
            <div className='flex flex-col gap-8'>
                {
                    projects.map((project, index) => (
                        <article
                            key={index}
                            className='bg-white dark:bg-dark/50 rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center md:items-start gap-6'
                        >
                            {/* Image container - left side on md+ */}
