...
//            <h1 className="text-xl md:text-3xl font-bold mb-5 text-center bg-clip-text text-transparent bg-gradient-to-r from-black to-blue-600">
//         My Projects
//       </h1>
...
//                     className="inline-block px-4 py-2 border border-blue-600 text-blue-600 dark:text-blue-400 rounded-md hover:bg-blue-600 hover:text-white dark:hover:bg-blue-400 dark:hover:text-black transition-colors duration-300"
//                   >
//                     View Details
//                   </Link>
//                 </div>
    ...
    <section className="py-6 md:py-8">
      <div className="container max-w-7xl px-4 md:px-20 mx-auto">
        ...
        <div className="text-center mt-8">
          <Link
            href="/projects"
            className="inline-block px-6 py-3 bg-gradient-to-r from-black to-blue-700 text-white rounded-xl font-semibold hover:from-gray-900 hover:to-blue-600 transition-all duration-300 shadow-lg"
          >
            See More Projects
          </Link>
        </div>
