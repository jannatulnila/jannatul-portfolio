    ...
    return (
        <section className="py-6 md:py-8">
            <div className='container max-w-7xl px-4 md:px-20 mx-auto'>
                {/* Section Header */}
                <div className="text-center mb-10">
                    <div className="inline-flex items-center gap-2 bg-black/10 dark:bg-blue-900/50 text-black dark:text-blue-400 px-4 py-2 rounded-full text-sm font-medium mb-6">
                        <div className="w-2 h-2 bg-black dark:bg-blue-500 rounded-full animate-pulse"></div>
                        Academic Journey
                    </div>
                    <h2 className='text-xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4'>
                        Education & <span className="bg-gradient-to-r from-black to-blue-600 bg-clip-text text-transparent">Learning</span>
                    </h2>
                    <p className="text-gray-600 dark:text-gray-400 text-md max-w-2xl mx-auto">
                        My academic background and continuous learning journey in technology
                    </p>
                ...
                <div className='grid gap-8 mb-12'>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-black to-blue-600 rounded-xl shadow-lg">
                                <GraduationCap className="w-6 h-6 text-white" />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                                Formal Education
                        ...
                        {education.map((edu, index) => (
                            ...
                            >
                                {/* Decorative gradient */}
                                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-black to-blue-600"></div>
                                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-black/10 to-blue-400/10 rounded-full -translate-y-12 translate-x-12"></div>
                                
                                <div className="space-y-4">
                                    {/* Degree Title */}
                                    <h4 className='text-2xl font-bold text-gray-900 dark:text-white group-hover:text-black dark:group-hover:text-blue-400 transition-colors mb-3'>
                                        {edu.degree}
                                    </h4>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4 mb-6">
                                        <div className="flex items-center gap-3">
                                            <div className="flex items-center justify-center w-10 h-10 bg-black/10 dark:bg-blue-900/50 rounded-lg">
                                                <BookOpen className="w-6 h-6 text-black dark:text-blue-400" />
                                            </div>
                                            <div>
                                                <p className="text-sm text-gray-500 dark:text-gray-400">Major</p>
                                                <p className='text-gray-700 dark:text-gray-300 font-medium'>{edu.major}</p>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="flex items-center justify-center w-8 h-8 bg-black/10 dark:bg-blue-900/50 rounded-lg">
                                                <MapPin className="w-4 h-4 text-black dark:text-blue-400" />
                                            </div>
                                            <div>
                                                <p className="text-sm text-gray-500 dark:text-gray-400">Institution</p>
                                                <p className='text-gray-700 dark:text-gray-300 font-medium'>{edu.institution}</p>
                                        ...
                                        <div className="flex items-center gap-3 md:col-span-2">
                                            <div className="flex items-center justify-center w-8 h-8 bg-black/10 dark:bg-blue-900/50 rounded-lg">
                                                <Calendar className="w-4 h-4 text-black dark:text-blue-400" />
                                            </div>
                                            <div>
                                                <p className="text-sm text-gray-500 dark:text-gray-400">Duration</p>
                                                <p className='text-gray-700 dark:text-gray-300 font-medium'>{edu.duration}</p>
                                    ...
                                    {edu.highlights && edu.highlights.length > 0 && (
                                        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                                            <h5 className="text-sm font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                                                <Award className="w-4 h-4 text-black dark:text-blue-400" />
                                                Key Highlights
                                            </h5>
                                            <ul className="space-y-2">
                                                {edu.highlights.map((highlight, i) => (
                                                    <li key={i} className='flex items-start gap-3 text-gray-600 dark:text-gray-300'>
                                                        <CheckCircle className="w-4 h-4 text-black dark:text-blue-400 mt-0.5 flex-shrink-0" />
                                                        <span>{highlight}</span>
                                                    </li>
                                                ))}
                                            </ul>
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-black to-blue-600 rounded-xl shadow-lg">
                                <BookOpen className="w-6 h-6 text-white" />
                            </div>
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                                Courses & Certifications
