...
const Hero = () => {
  return (
    <section className="container max-w-7xl mx-auto px-4 md:px-20">
      <div className="flex flex-col-reverse lg:flex-row items-center gap-12 mt-0">
        
        {/* Left Side - Content */}
        <div className="space-y-8 animate-fade-in w-full lg:w-1/2">
          {/* Greeting */}
          <div>
            <p className="text-gray-600 dark:text-gray-400 text-lg mb-2 font-light">
              Hello, I am
            ...
            <h1 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 leading-tight">
              Jannatul Fardous{' '}
              <span className="bg-gradient-to-r from-black to-blue-700 bg-clip-text text-transparent">
                Nila
              </span>
            </h1>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-3 mb-3">
              <div className="flex items-center gap-2 bg-black/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-lg px-3 py-2 shadow-sm border border-blue-700">
          ...
          <div className="flex gap-4 flex-wrap">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-center w-12 h-12 bg-black/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl text-blue-500 hover:text-white hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 border border-blue-700"
              aria-label="GitHub Profile"
            >
              <Github className="w-5 h-5" />
            </a>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center gap-3 bg-gradient-to-r from-black to-blue-700 text-white px-6 py-2 rounded-xl hover:from-gray-900 hover:to-blue-800 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl hover:scale-105 transform"
            >
              <Download className="w-5 h-5 group-hover:animate-bounce" />
              View Resume
            </a>
            <a
              href="/contact"
              className="group inline-flex items-center justify-center gap-3 bg-black/70 dark:bg-gray-800/70 backdrop-blur-sm border-2 border-blue-700 text-white dark:text-gray-300 px-6 py-2 rounded-xl hover:bg-blue-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl hover:scale-105 transform"
            >
              <Mail className="w-5 h-5 group-hover:animate-pulse" />
              Contact Me
            </a>
        ...
        <div className="flex justify-center lg:justify-end w-full lg:w-1/2 mb-8 lg:mb-0">
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-black to-blue-700 dark:from-gray-900 dark:to-blue-800 rounded-full p-6 shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:scale-105">
              <div className="relative overflow-hidden rounded-full ring-4 ring-blue-500 shadow-xl">
                <Image
                  src="/profile-1.png"
                  alt="profile"
                  width={320}
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-blue-700 rounded-full animate-bounce animation-delay-1000 opacity-80"></div>
            </div>
          </div>
        </div>
